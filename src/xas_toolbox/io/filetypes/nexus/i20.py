...
class I20Reader(NxsReader):
    ...
    Attributes:
        ...
        scanMeta (dict): Paths to scan metadata (currently <b>start_time, end_time,
                                                            repetition_files</b>).
        elementMeta (dict): Paths to element metadata (currently <b>symbol, edge,
        reference,
                                                             ref_edge</b>).
        transParams (dict): Paths to transmission data: <b>mutrans, energy, i0,
          itrans</b>.
        ...
        mcaParams (dict): Paths to MCA data <b>dtc_factors, raw_scaler_in_window,
        mcas</b>.
    """
