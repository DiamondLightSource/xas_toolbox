...
class I20_1Reader(NxsReader):
    ...
    Attributes:
        ...
        referParams (dict): Paths to reference data: <b>murefer, irefer</b>, these will all be
                            `None`.
    ...
    def __init__(self, path):
        ...
        self.elementMeta["_path"] = ["entry1/metaData", "polynomial", "referenceDataFileName"]
    ...
    def _make_elementMeta(self)->None:
    ...
    def _get_ElementMeta(self, val:ElementMeta)->Union[str, None]:
        ...
        if val not in self.elementMeta.keys():
            logger.warning(f"{val} not present in file"); return
