"""
Classes for detection-mode specific measurements (i.e. fluorescence, transmission, reference + metadata).
"""
...
class AuxMeasurement():
    ...
    """
    def __init__(self, get_value:Callable[[Union[ScanData, str]], Any]):
...
class FluorMeasurement():
    ...
    def __init__(self, get_value:Callable[[Union[ScanData, str]], Any]):
        ...
        self._ifluor = None; self._mufluor = None
...
class TransMeasurement():
    ...
    def __init__(self, get_value:Callable[[Union[ScanData, str]], Any]):
        ...
        self._itrans = None; self._mutrans = None
...
class RefMeasurement():
    ...
    def __init__(self, get_value:Callable[[Union[ScanData, str]], Any]):
        ...
        self._irefer = None; self._murefer = None
...
class McaMeasurement():
    ...
    def __init__(self, get_value:Callable[[Union[ScanData, str]], Any]):
        ...
        self._dtc_factors = None; self._mcas = None
...
class XasMeta():
    ...
    """
    def __init__(self, get_value:Callable[[Union[ScanMeta, ElementMeta, str]], 
                                          Any]):
        self._get_value = get_value

        self._path = None; self._repetition_files = None
        self._start_time = None; self._end_time = None

        self._symbol = None; self._ref_symbol = None
        self._edge = None; self._ref_edge = None
